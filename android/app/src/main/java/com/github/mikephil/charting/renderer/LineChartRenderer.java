...
public class LineChartRenderer extends LineRadarRenderer {
    ...
    protected void drawShadow(Canvas c, ILineDataSet dataSet, Path spline) {
        ...
        mRenderPaint.setShadowLayer(10, 0, 30, color);
    ...
    protected void drawLinear(Canvas c, ILineDataSet dataSet) {
        ...
        if (dataSet.getColors().size() > 1) {
            ...
            for (int j = mXBounds.min; j <= mXBounds.range + mXBounds.min; j++) {
                ...
                if (j == mXBounds.min && dataSet.isDrawShadowEnabled()) {
                    int color = dataSet.getShadowColor();
                    mRenderPaint.setShadowLayer(10, 0, 20, color);
                }
    ...
    private class DataSetImageCache {
        ...
        protected void fill(ILineDataSet set, boolean drawCircleHole, boolean drawTransparentCircleHole) {
            ...
            for (int i = 0; i < colorCount; i++) {
                ...
                //加上阴影的宽度
                if (set.isDrawShadowEnabled()) {
                    circleBitmap = Bitmap.createBitmap((int) ((circleRadius + 5) * 2.1), (int) ((circleRadius+5) * 2.1), conf);
                }
                ...
                if (drawTransparentCircleHole) {
                    ...
                    if (set.isDrawShadowEnabled()) {
                        ...
                        mCirclePathBuffer.addCircle(
                                ...
                                circleHoleRadius,
                                Path.Direction.CCW);
                        int color = set.getShadowColor();
                        mRenderPaint.setColor(color);
                        mRenderPaint.setMaskFilter(new BlurMaskFilter(2, BlurMaskFilter.Blur.OUTER));
                        canvas.drawPath(mCirclePathBuffer, mRenderPaint);
                    }
                } else {
