...
import com.yaofangwang.zxing.open.OpenCameraInterface;
...
public final class CameraManager {
	 ...
	 * {@link com.yaofangwang.mall.activity.home_hxk.android.CaptureActivity}
	 * 
	 * @param newSetting
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			framingRect = new Rect(leftOffset, topOffset, leftOffset + size,
					topOffset + size);
