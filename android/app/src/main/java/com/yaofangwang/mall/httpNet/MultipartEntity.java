...
public class MultipartEntity implements HttpEntity {
     ...
     * @param rawData
     */
    public void addBinaryPart(String paramName, final byte[] rawData, String name) {
        if (null == name || name.length() == 0) {
            name = "no-file.png";
        }
        writeToOutputStream(paramName, rawData, TYPE_OCTET_STREAM, BINARY_ENCODING, name);
    }
    ...
    public void addBinaryPart(String paramName, final byte[] rawData) {
        addBinaryPart(paramName, rawData, null);
    }
