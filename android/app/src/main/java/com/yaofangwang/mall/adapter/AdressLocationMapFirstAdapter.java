...
public class AdressLocationMapFirstAdapter extends _BaseAdapter<PoiInfo> {

    public AdressLocationMapFirstAdapter(Context context) {
        super(context);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            convertView = mInflater.inflate(R.layout.view_address_location_nearly, parent, false);
