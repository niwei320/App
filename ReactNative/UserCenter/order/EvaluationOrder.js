...
export default class EvaluationOrder extends React.Component {
            ...
            <View style ={{flex:1}}>
                ...
                >
                    ...
                    <View style = {[BaseStyles.radiusShadow,{backgroundColor:'#FFF',marginTop:13,marginLeft:13,marginRight:13}]}>
                        <TouchableOpacity style={{width:width-26}} onPress={()=>{dismissKeyboard_yfw()} } onPressIn={()=>{dismissKeyboard_yfw()}}
                            ...
                            {/* <View style={{backgroundColor:'#E5E5E5',width:width-26,height:0.5,marginLeft:10}}/> */}
                ...
                <View style={{position:'absolute',bottom:20,flex:1}}>
                        <TouchableOpacity activeOpacity={1}
                                            style={{width:width-12,left:6,height:56,alignItems:'center',justifyContent:'center',}}
                                            onPress={()=>{
                                                this._commit()
                                            }
                                            }>
                                <ImageBackground style={[{width:width-12,height:56,borderRadius:21,alignItems:'center'}]}
                                    imageStyle={{resizeMode:'stretch'}}
                                    source={require('../../../img/button_commit_hlight.png')}>
                                    <Text style={{color:'white',fontSize:16,paddingTop:16}}>提交</Text>
                                </ImageBackground>
                                <View style={{width:width,height:isIphoneX()?34+10:10}}/>
    ...
    _commit() {
        ...
        paramMap.set('__cmd', 'person.order.evaluation');
    ...
    _renderInputView() {
        return (<View style={{backgroundColor:'#fff',height:100,marginLeft:13,marginRight:13,borderStyle: 'solid',
        borderWidth: 0.5,
        borderColor: '#cccccc'}}>
            <TextInput
