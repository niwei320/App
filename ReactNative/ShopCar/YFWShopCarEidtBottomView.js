...
import YFWRecomendGoodsModel from "../HomePage/Model/YFWRecomendGoodsModel";
import {safeArray} from "../PublicModule/Util/YFWPublicFunction";

export default class YFWShopCarEidtBottomView extends Component {
        ...
        return (
            <View style={{flex:1}}>
                ...
                <View style={styles.container}>
                    ...
                    <View style={{flex:1}}/>
                    {!this.props.hiddenCollection&&<View style={styles.view2Style}>
    ...
    _orderShouCangMethod(){
        let itemStr = '';
        safeArray(this.props.Data).forEach((item,index)=>{
            let str = '';
