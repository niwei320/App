...
import {kScreenWidth, tcpImage, safeObj, safeArray} from '../PublicModule/Util/YFWPublicFunction';
...
export default class YFWShopCarStaleCell extends Component {
    ...
    render(){
        ...
        if ( safeArray(this.props.DataArray).length === 0) {
            return (<View/>)
        }
        return (
    ...
    renderMedicineCell(){
        ...
        let allCell = []
        safeArray(this.props.DataArray).map((badge,index)=>{
            allCell.push(
