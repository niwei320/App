...
export default class YFWWDSwitchAddressView extends Component {
    ...
    _renderTitleItem(title, index) {
        ...
        return(
            <View style={[BaseStyles.centerItem,{height:42,marginRight:10,overflow:'hidden',flex:1}]}>
                ...
                <Image source={YFWImageConst.Icon_title_bottom_line} style={{height:12, resizeMode:'stretch', position:'absolute', left:-30,right:0,bottom:7, flex:1, opacity:opacity}}/>
            </View>
        )
    }
