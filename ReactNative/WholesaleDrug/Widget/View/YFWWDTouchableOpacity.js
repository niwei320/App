...
export default class YFWWDTouchableOpacity extends Component {
    render() {
    ...
    _renderGradient() {
        ...
        return(
            <TouchableOpacity activeOpacity={1} onPress={this._touchableClick.bind(this)} style={[styles.shawddow,{marginBottom:10,shadowColor:this.props.isEnableTouch ? "rgba(84, 124, 255, 0.5)" : "rgba(204, 204, 204, 0.5)"}]}>
                <LinearGradient
                    colors={this.props.isEnableTouch ? ['rgb(51,105,255)','rgb(50,87,234)'] : ['#ccc','#ccc']}
