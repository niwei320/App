...
import YFWWDOrderTypeChooseView from "./View/YFWWDOrderTypeChooseView";
import YFWWDCounterfeitDrugExplanationView from "./View/YFWWDCounterfeitDrugExplanationView";
...
export default class YFWWDOrderReportDetailPage extends Component {
...
//-----------------------------------------------METHOD---------------------------------------------
    ...
    _commit() {
        ...
        paramMap.set('__cmd', 'store.whole.order.complaint');
...
//-----------------------------------------------RENDER---------------------------------------------
    _renderWarningView(){
        return (
            <View style={{flexDirection:'row',alignItems:'center',paddingTop:12,paddingBottom:10,paddingLeft: 10,paddingRight:13}}>
                <Image source={YFWImageConst.Icon_warning_complain} style={{width:27,height:27,resizeMode:'contain'}}/>
                ...
                {isReasonCounterfeitDrug?
                    <View style={{flex:1,alignItems:'flex-end'}}>
                        <TouchableOpacity style={{flexDirection:'row',alignItems:'center',marginRight:13}}
                            ...
                            <Image source={YFWImageConst.Icon_gary_wenhao} style={{width:14,height:14,marginLeft:6,resizeMode:'contain'}}/>
                        </TouchableOpacity>
                    </View>
                    :null}
            </View>
                            ...
                            <View style={{alignItems:'center', justifyContent:'center',width: 90, height: 90,marginRight:10 }} key={index}>
                                ...
                                <TouchableOpacity onPress={() => this._removePic(index)} style={{ position: 'absolute', right: -8, top: -8 }}
                                    ...
                                    <Image style={{ width: 15, height: 15, resizeMode: "cover" }}
                                           source={YFWImageConst.Icon_del_pic} />
                                </TouchableOpacity>
                            </View>
                        );
                    }):null}
                    {imageData.length < IMAGE_UPLOAD_MAX?
                        <View style={{alignItems:'center', justifyContent:'center',width: 90, height: 90 }} key={imageData.length}>
                            <TouchableOpacity onPress={() => this._selectPic()} activeOpacity={1}>
                                <ImageBackground style={{ width: 90, height: 90, resizeMode: "contain" }}
                                       source={YFWImageConst.Icon_upload_photo} >
    ...
    _renderPhoneNumber() {
        return (
            <TouchableOpacity onPress={() => {this.phoneNumberInput&& this.phoneNumberInput.focus()}} activeOpacity={1}
        ...
        return (
            <TouchableOpacity style={{ width: kScreenWidth}} onPress={() => { dismissKeyboard_yfw() }} activeOpacity={1}>
                ...
                <View style={style.bottomBtmView}>
                    <YFWWDTouchableOpacity style_title={{ height: 44, width: kScreenWidth - 13 * 2, fontSize: 17 }}
                                         title={'提交申请'}
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1 , backgroundColor:'RGB(250,250,250)'}}>
                ...
                <YFWWDCounterfeitDrugExplanationView ref={(c) => this.explanationView = c} />
                <YFWWDOrderTypeChooseView ref={(c) => this.chooseView = c} />
            </View>
        )
    }
