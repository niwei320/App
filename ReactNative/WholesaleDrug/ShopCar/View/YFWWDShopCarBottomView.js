...
export default class YFWWDShopCarBottomView extends Component {
                    ...
                    {!this.state.noLocationHidePrice ?
                        <View style={[styles.view1Style, { alignItems: 'flex-end',flex: 2}]}>
                            <View style={[BaseStyles.leftCenterView, { height: 30 }]}>
                                <Text style={{ fontSize: 13, color: darkTextColor(), fontWeight: 'bold' }}>合计：</Text>
    ...
    _orderSettlementMethod() {
        this.props.orderSettlementMethod&&this.props.orderSettlementMethod()
        return
