...
import { isEmpty, isNotEmpty, kScreenWidth, safe, tcpImage, safeObj } from "../../../PublicModule/Util/YFWPublicFunction";
...
export default class YFWWDShopCarPackageCellView extends Component {
    ...
    _getPackageReserve() {
        ...
        let reserve = 99999;
        this.props.Data.package_medicines.forEach((item, index, array) => {
    ...
    render() {
        ...
        if (isNotEmpty(this.props.Data.reserve_desc) && this.props.Data.reserve_desc.length > 0) {
            bottomHeight = 70;
    ...
    _renderItem() {
        return (
            <YFWWDSwipeRow Data={this.props.Data.package_medicines}
