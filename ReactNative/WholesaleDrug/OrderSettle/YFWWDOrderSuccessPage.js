...
import { TYPE_SIGN_POINTS, getWDSignInData } from '../../Utils/YFWInitializeRequestFunction';
...
export default class YFWWDOrderSuccessPage extends Component {
        ...
        viewModel.TCPRequest(paramMap, (res) => {
            ...
            if (isNotEmpty(data)) {
                ...
                this.setState({
                    ...
                    ad_app_payment:safeObj(data.ad_app_payment)['0'],
    ...
    _clickAd(adBadge) {
        if (adBadge.name && adBadge.name.startsWith('签到')) {
            ...
            pushWDNavigation(this.props.navigation.navigate, adBadge);
        }
    }
    ...
    _renderLargeBtn() {
        ...
        let adBadge = safeObj(this.state.ad_app_payment);
