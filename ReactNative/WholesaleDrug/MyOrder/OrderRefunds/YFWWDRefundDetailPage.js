...
import { backGroundColor,yfwBlueColor } from "../../../Utils/YFWColor";
...
import YFWWDRefundDetailHeaderView from './View/YFWWDRefundDetailHeaderView';
import YFWWDRefundsGoodsItemView from './View/YFWWDRefundsGoodsItemView';
import { pushWDNavigation, kRoute_refund_negotiation, kRoute_logistics } from '../../YFWWDJumpRouting';
import YFWWDOrderClick from '../View/YFWWDOrderClick';
import YFWWDLogisticsInfoView from './View/YFWWDLogisticsInfoView';
import YFWWDRetrunGoodsInfoModel from './Model/YFWWDRetrunGoodsInfoModel';
import YFWWDRetrunGoodsDetailInfoModel from './Model/YFWWDRetrunGoodsDetailInfoModel';

export default class YFWWDRefundDetailPage extends Component {
    ...
    _jumpToNegotiationPage() {
        ...
        pushWDNavigation(navigate, { type: kRoute_refund_negotiation, orderNo: this.orderNo })
    }
    ...
    _getReturnGoodsOtherInfo(type) {
        ...
        paramMap.set('__cmd', 'store.buy.order.getReturnInfo');
        ...
        viewModel.TCPRequest(paramMap, (res) => {
            ...
            let dataArray = YFWWDRetrunGoodsDetailInfoModel.getModelArray(res.result);
            this.setState({
    ...
    _getReturnGoodsList() {
        let paramMap = new Map();
        let viewModel = new YFWRequestViewModel();
        paramMap.set('__cmd', 'store.buy.order.getReturnGoodsInfo');
        paramMap.set('orderno', this.orderNo);
        viewModel.TCPRequest(paramMap, (res) => {
            if (isEmpty(res.result)) {
                return
    ...
    _returnButtonClick(type) {
        ...
        YFWWDOrderClick.buttonsClick(item)
    }
    ...
    _trackLogistics() {
        ...
        pushWDNavigation(navigate, { type: kRoute_logistics, orderNo: this.orderNo, img_url: imageUrl, from: 'return' });
    }
        ...
        return (
            ...
            >
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <Image style={{ width: 15, height: 15, marginLeft: 7, marginRight: 7, resizeMode: 'stretch' ,tintColor:yfwBlueColor()}}
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: backGroundColor() }}>
                ...
                <YFWWDLogisticsInfoView ref={(e) => this.logisticsInfoView = e} navigation={this.props.navigation} callBack={() => {
                    this._requestData('init')
                }} ></YFWWDLogisticsInfoView>
            </View>
        )
    }
