...
import { kRoute_logistics_company, pushWDNavigation } from '../../../YFWWDJumpRouting';
export default class YFWWDLogisticsInfoView extends Component {
    constructor(...args) {
        super(...args);
        this.state = {
    ...
    _selectLogisticsCompany() {
        if (this.props.navigation) {
            ...
            pushWDNavigation(navigate, {type: kRoute_logistics_company,callBack:(result)=>{
    ...
    _confirmClickAction() {
        ...
        paramMap.set('__cmd', 'store.buy.order.sendReturnGoods');
