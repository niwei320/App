...
export default class YFWWDRefundDetailHeaderView extends Component {
            ...
            processCheckPoint.push(
                <View style={{alignItems: 'center'}}>
                    <Image style={{width:25*rpx,height:25*rpx,resizeMode:'stretch'}}
                           source={isProcessing&&index+1===this.state.process.length? require('../../../../../img/icon_check_green_off.png'):YFWImageConst.Icon_progress_on}/>
