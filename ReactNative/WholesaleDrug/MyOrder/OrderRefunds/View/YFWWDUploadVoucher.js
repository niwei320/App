...
export default class YFWWDUploadVoucher extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            imageUris: [DEFAULT],
    ...
    render() {
        if (this.props.is_upload_img == 'true') {
            return (
                <View >
                    <YFWTitleView title={'上传凭证'} style_title={{fontSize:13,color:'#333333'}} hiddenBgImage={true} />
