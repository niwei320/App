...
import MyTextInput from "./YFWTextInput";
...
import {TYPE_DOUBLE, TYPE_NOMAL, TYPE_OTC, TYPE_SINGLE} from "./YFWPrescribedGoodsTitle";
import YFWPrescribedGoodsTitle from "./YFWPrescribedGoodsTitle";

export default class YFWGoodsListItemView extends Component {
        ...
        if(this.state.isSelectable){
            return (
                <Image style={{width:22, height:22, marginLeft:7, marginRight:11, resizeMode:'stretch'}}
                       source={this.state.isSelected?require('../../img/chooseBtnNoShadow.png'):require('../../img/check_discheck.png')}/>
            )
        } else {
