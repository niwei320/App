...
export default class YFWStartScore extends Component {
  ...
  constructor(props) {
    ...
    this.starIcon = {'red':require('../../img/bottom_icon_collect_selected.png'),
                      'orange':require('../../img/sx_star.png')
                    }
  }
    ...
    for (let i = 0; i < this.total; i++) {
      stars.push(<View key={"star-o-"+i}>
        <Image style = {{marginHorizontal: this.starSpacing,width: this.starSize * 0.93,height:this.starSize * 0.93,}}
            source={require('../../img/nearly_star_disenable.png')} defaultSource={require('../../img/nearly_star_disenable.png')}
        />
      </View>);
    }
