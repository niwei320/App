...
import Animation from '../widget/YFWAnimation';
...
class YFWZoomImage extends Component {
    static propTypes = {
...
class ImageModal extends Component {
    ...
    _updateNativeStyles(dy) {
        ...
        this._modalStyle.style.backgroundColor = `rgba(245,245,245, ${1 - Math.abs(dy) / winHeight * 0.9})`;
...
YFWZoomImage.ImageModal = ImageModal;

export default YFWZoomImage;
