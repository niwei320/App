...
/**
 解决CDN获取IP慢的问题
 cachedAddress缓存获取到的列表
 cachedHost缓存host
 cachedPort缓存的port
 */
static const NSMutableArray *cachedAddress = nil;
static const NSString *cachedHost = nil;
...
{
	LogTrace();
  if (cachedAddress&&[cachedHost isEqualToString:host]&&cachedPort == port) {
