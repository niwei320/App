...
#import "YFWReachability.h" // 网络状态获取
#import "UIDevice+YFWPhoneInfo.h"
@implementation YFWPhoneInfo
...
+ (void)setDeviceType:(YFWDeviceType)deviceType{}
+ (YFWDeviceType)deviceType{
...
// 当前设备的 CPU 类型
+ (void)setDeviceCPUType:(YFWCPUType)deviceCPUType{}
+ (YFWCPUType)deviceCPUType{
    ...
    switch (hostInfo.cpu_type) {
        case CPU_TYPE_ARM:
            return YFWCPUTypeARM;
            break;
            
        case CPU_TYPE_ARM64:
            return YFWCPUTypeARM64;
            break;
            
        case CPU_TYPE_X86:
            return YFWCPUTypeX86;
            break;
            
        case CPU_TYPE_X86_64:
            return YFWCPUTypeX86_64;
            break;
            
        default:
            return YFWCPUTypeUnkown;
            break;
    }
}
...
+ (NSString *)deviceNetType{
    ...
    NetworkStatus status = [reach currentYFWReachabilityStatus];
    switch (status) {
        case NotReachable:
            networktype = @"无服务";
            break;
