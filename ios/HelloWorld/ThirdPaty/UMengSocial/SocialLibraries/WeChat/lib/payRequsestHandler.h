...
#define APP_ID          @"wx09c361de9c7a3822"               //APPID
#define APP_SECRET      @"bca8c72e6794399ad14b54d67680624d" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1248518701"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"9411af079b3c04e1d41fcfc9763690be"
//支付结果回调页面
#define NOTIFY_URL      @"https://cert.yaofangwang.com/WxPay_APP_ResultNotify.aspx"
//获取服务器端支付数据地址（商户自定义）
...
//签名实例测试
- ( NSMutableDictionary *)sendPay_demo:(NSDictionary *)item;
